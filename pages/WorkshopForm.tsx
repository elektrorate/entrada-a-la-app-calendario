...
export const WorkshopForm: React.FC = () => {
  ...
  const handleCreateAdmin = (e: React.FormEvent) => {
    ...
    // Crear el perfil del administrador localmente
    ...
    setAdminData(prev => ({ ...prev, id: newUserId }));
    setWorkshopData(prev => ({ ...prev, adminGeneralUserId: newUserId }));
    setAdminConfirmed(true);
    setCurrentStep(2);
    showToast(`Administrador '${adminData.nombre}' registrado correctamente`, 'success');
  };

  const handleFinalizeWorkshop = (e: React.FormEvent) => {
    e.preventDefault();
          ...
          <form onSubmit={handleCreateAdmin} className="space-y-6">
            ...
            {!adminConfirmed && (
                <div className="flex justify-end pt-4">
                    <Button type="submit" variant="dark" className="w-full md:w-auto shadow-2xl">
